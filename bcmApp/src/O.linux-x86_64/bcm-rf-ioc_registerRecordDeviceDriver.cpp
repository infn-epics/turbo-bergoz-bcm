...
/* Generated from ../O.Common/bcm-rf-ioc.dbd */
...
epicsShareExtern reg_func pvar_func_aCalcMonitorMemRegister,
    ...
    pvar_func_bcmAsynMonRegister, pvar_func_dbndInitialize,
    ...
    pvar_func_rsrvRegistrar, pvar_func_subAveRegister,
...
int bcm_rf_ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/app/IOC-DEVEL/turbo-bergoz-bcm";
    ...
    runRegistrarOnce(pvar_func_bcmAsynMonRegister);
...
/* bcm_rf_ioc_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: bcm_rf_ioc_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(bcm_rf_ioc_registerRecordDeviceDriver(*iocshPpdbbase));
}
